...
//        System.out.println("hook AppPlugin demo");
//        super.apply(project);
//    }
//}
...
//
//        * Where:
//        Build file 'F:\github\dir_demos\AndroidSample\app\build.gradle.kts' line: 3
//
//        * What went wrong:
//        An exception occurred applying plugin request [id: 'org.jetbrains.kotlin.android']
//        > Failed to apply plugin 'org.jetbrains.kotlin.android'.
//        > Extension with name 'android' does not exist. Currently registered extension names: [ext, base, defaultArtifacts, kotlin, kotlinTestRegistry]
//
//        * Try:
...
//        ... 189 more
//        Caused by: org.gradle.api.UnknownDomainObjectException: Extension with name 'android' does not exist. Currently registered extension names: [ext, base, defaultArtifacts, kotlin, kotlinTestRegistry]
...
//        at org.jetbrains.kotlin.gradle.plugin.AbstractAndroidProjectHandler.configureTarget(KotlinPlugin.kt:742)
//        at org.jetbrains.kotlin.gradle.plugin.KotlinAndroidPlugin$Companion$dynamicallyApplyWhenAndroidPluginIsApplied$2$1.execute(KotlinPlugin.kt:690)
//        at org.jetbrains.kotlin.gradle.plugin.KotlinAndroidPlugin$Companion$dynamicallyApplyWhenAndroidPluginIsApplied$2$1.execute(KotlinPlugin.kt:687)
...
//        at org.jetbrains.kotlin.gradle.plugin.KotlinAndroidPlugin$Companion.dynamicallyApplyWhenAndroidPluginIsApplied$kotlin_gradle_plugin_common(KotlinPlugin.kt:687)
//        at org.jetbrains.kotlin.gradle.plugin.KotlinAndroidPlugin.apply(KotlinPlugin.kt:645)
//        at org.jetbrains.kotlin.gradle.plugin.KotlinAndroidPlugin.apply(KotlinPlugin.kt:638)
